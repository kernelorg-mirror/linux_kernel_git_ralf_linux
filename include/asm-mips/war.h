 ...
 * exceptions.
 */
#if defined(CONFIG_MOMENCO_JAGUAR_ATX) || defined(CONFIG_MIPS_ATLAS) || \
    defined(CONFIG_MIPS_EV96100) || defined(CONFIG_MIPS_MALTA) || \
    defined(CONFIG_MOMENCO_OCELOT) || defined(CONFIG_MOMENCO_OCELOT_3) || \
    defined(CONFIG_MOMENCO_OCELOT_C) || defined(CONFIG_MOMENCO_OCELOT_G) || \
